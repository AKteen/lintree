            ...
            <div className="links">
                <ul>
                    <li id="strava-link" className="link-item strava">
                        ...
                        <a href="https://strava.app.link/sK6dxaM983b" target="_blank" rel="noopener noreferrer">My Strava</a>
                    </li>
                    <li id="linkedin-link" className="link-item linkedin">
                        <img src="/link.png" className='icons' alt="LinkedIn"/>
                        <a href="https://www.linkedin.com/in/aditya-k-92911b1b9?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer">My LinkedIn</a>
                    </li>
